...
{{
  ...
  "message_whatsapp": "Message WhatsApp a envoyer IMMEDIATEMENT apres le call. Tutoiement. 4-5 lignes max. Structure OBLIGATOIRE : 1) Une phrase qui reflete son objectif principal avec SES mots exacts. 2) Une phrase qui montre qu'on a entendu son vrai blocage. 3) Annonce le lien vers sa feuille de route en disant qu'elle est faite uniquement pour lui - mets le placeholder [LIEN] a cet endroit. 4) Une phrase courte qui cree l'envie de lire maintenant. INTERDIT : dates, mentions de prochain call, flagornerie. Ton : direct, humain, premium."
}}
"""
...
def build_html(ctx, phases, url_publique):
    prenom = ctx["prenom"]
    nom = ctx["nom"]
    ...
    if ca_level == "high":
        featured_price, featured_label = "5 000&euro;", "Accompagnement complet"
        featured_features = ["Plateforme + Slack + Lives", "3 mois de suivi 1-to-1", "Garantie 3-10k&euro;/mois en 90 jours"]
        alt_price, alt_label = "1 500&euro;", "Acces plateforme"
        alt_features = ["Plateforme + Slack + Lives", "Sans suivi 1-to-1", "Sans garantie"]
    else:
        featured_price, featured_label = "1 500&euro;", "Acces plateforme"
        featured_features = ["Plateforme + Slack + Lives", "Upgrade possible", "Sans suivi 1-to-1"]
        alt_price, alt_label = "5 000&euro;", "Accompagnement complet"
        alt_features = ["Plateforme + Slack + Lives", "3 mois de suivi 1-to-1", "Garantie 3-10k&euro;/mois en 90 jours"]
...
<style>
  ...
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .vision-list li::before {{ content: '\2192'; color: var(--red); font-size: 12px; margin-top: 2px; flex-shrink: 0; }}
  ...
  .offer-features li::before {{ content: '\2713'; position: absolute; left: 0; color: var(--red); font-size: 11px; }}
...
<div class="container">
  <header class="header">
    <p class="header-tag">L'Academie des Coachs &middot; Feuille de route</p>
  ...
  <section>
    ...
    <h2 class="section-title">Ton point B &mdash; <em>{driver}</em></h2>
    <ul class="vision-list">
      ...
      <li>La liberte de choisir avec qui tu travailles &mdash; et pourquoi.</li>
    </ul>
  </section>
  <section>
    <p class="section-tag">02</p>
    <h2 class="section-title">Ton point A &mdash; les faits.</h2>
  ...
  <section>
    ...
    <h2 class="section-title">Ce que ca donne &mdash; en chiffres.</h2>
    <div class="proofs-wrap">
      <ul class="proofs">
        <li><span class="proof-name">Manon</span><span class="proof-val" data-target="150000">0</span></li>
        <li><span class="proof-name">Emmerick &mdash; janvier</span><span class="proof-val" data-target="15000">0</span></li>
        <li><span class="proof-name">Emmerick + equipe &mdash; fevrier</span><span class="proof-val" data-target="19000">0</span></li>
        <li><span class="proof-name">Aurelie &mdash; 1 semaine</span><span class="proof-val" data-target="7000">0</span></li>
        <li><span class="proof-name">Nouvelle coach &mdash; 1 mois (0)</span><span class="proof-val" data-target="3300">0</span></li>
      </ul>
  ...
  <section class="closing">
    ...
    <a href="{wa_url}" target="_blank" rel="noopener" class="cta-btn"><span>Je suis pret, on lance</span><span>&#8594;</span></a>
  </section>
  <footer class="footer"><p>L'Academie des Coachs &middot; Document prepare pour {prenom} {nom}</p></footer>
</div>
<script>
...
def main():
    ...
    html = build_html(ctx, phases, url_publique)
    ...
    message_wa = ctx.get("message_whatsapp", "").replace("[LIEN]", url_publique)
